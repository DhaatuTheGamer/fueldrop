...
import { AlertTriangle, X, Headphones, MapPin, Ban, PhoneCall, RefreshCw, Edit3 } from 'lucide-react';
...
export default function LiveTracking() {
  ...
  return (
    <div className="min-h-screen bg-bg flex flex-col transition-colors">
      <LiveTrackingMap isPending={isPending} currentStatus={currentStatus} eta={eta} />
